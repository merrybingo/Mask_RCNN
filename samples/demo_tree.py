...
IMAGE_DIR = os.path.join(ROOT_DIR, "images_tree")
...
for i in range(1,21):
    ...
    # visualize.display_results(image, r['rois'], r['masks'], r['class_ids'], class_names, r['scores'], save_dir=save_dir, img_name=file_name)
