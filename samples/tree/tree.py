"""
Mask R-CNN
Train on the toy tree dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 tree.py train --dataset=/path/to/tree/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 tree.py train --dataset=/path/to/tree/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 tree.py train --dataset=/path/to/tree/dataset --weights=imagenet
...
def train(model):
    ...
    dataset_val.load_tree(args.dataset, "val")
    dataset_val.prepare()
